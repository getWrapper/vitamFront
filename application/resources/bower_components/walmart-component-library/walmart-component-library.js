...
angular.module('ngMaterial', ["ng","ngAnimate","ngAria","material.core","material.core.gestures","material.core.layout","material.core.theming.palette","material.core.theming","material.core.animate","material.components.autocomplete","material.components.backdrop","material.components.bottomSheet","material.components.button","material.components.card","material.components.checkbox","material.components.chips","material.components.datepicker","material.components.content","material.components.dialog","material.components.divider","material.components.fabActions","material.components.fabShared","material.components.fabSpeedDial","material.components.fabToolbar","material.components.fabTrigger","material.components.gridList","material.components.icon","material.components.input","material.components.menu","material.components.list","material.components.menuBar","material.components.progressCircular","material.components.radioButton","material.components.progressLinear","material.components.select","material.components.showHide","material.components.sidenav","material.components.slider","material.components.subheader","material.components.sticky","material.components.swipe","material.components.tabs","material.components.switch","material.components.toast","material.components.toolbar","material.components.tooltip","material.components.virtualRepeat","material.components.whiteframe"]);
})();
(function(){
"use strict";
...
function MdCoreConfigure($provide, $mdThemingProvider) {
  ...
  $mdThemingProvider.theme('default')
    .primaryPalette('walmart-medium-blue')
    .accentPalette('walmart-green')
    .warnPalette('walmart-red')
...
.constant('$mdColorPalette', {
  ...
  'walmart-yellow': {
      ...
      'A700': '#e2a400',
      'contrastDefaultColor': 'light',
      'contrastDarkColors': '50 100 200 300 400 500 600 700 800 A100 A400 A700'
  },
  'walmart-green': {
    '50': '#c8e6b4',
    '100': '#c8e6b4',
 ...
 * the checkbox is in the primary color by default. The accent color palette may be used with
 * the `md-accent` class.
 *
...
function ngMessageDirective($mdUtil) {
  ...
  function compile(element) {
    ...
    element.prepend('<md-icon class="md-validation-icon" md-font-icon="ion-alert-circled"></md-icon>');
  ...
  function compile(element, attr) {
    ...
    return function postLink(scope, element, attr, ctrls) {
      ...
      mdSelectCtrl.setLabelText = function(text) {
        // Removed the temporary placeholder so that an always floating label could be added.
