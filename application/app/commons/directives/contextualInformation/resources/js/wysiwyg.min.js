! function(e, t) {
    ...
    e.module("ngWYSIWYG", ["ngSanitize"]), e.module("ngWYSIWYG").config(["$provide", function(e) {
        ...
        function r(e) {
            ...
            var t = e.pageY,
                n = t - (v.getBoundingClientRect().top + d.pageYOffset);
    ...
    return e.module("ngWYSIWYG").directive("wysiwygEdit", ["ngpUtils", "NGP_EVENTS", "$rootScope", "$compile", "$timeout", "$q", function(n, o, i, r, a, l) {
        ...
        var l = function(i, l, s, t, c) {
            loadIframe(i, l, s, t, c, r, o, n, e, a);
        };
        return {
            link: l,
            require: "ngModel",
        ...
        return function(t, n) {
            ...
            r.className = "resizer", i.appendChild(r), r.addEventListener("mousedown", function() {
                function e(e) {
                    ...
                    var n = t - (i.getBoundingClientRect().top + o.defaultView.pageYOffset),
...
function loadIframe(i, l, s, t, c, r, o, n, e, a) {
    var d = l[0].contentDocument;
    if (d == null) {
        setTimeout(loadIframe.bind(this, i, l, s, t, c, r, o, n, e, a), 100);
    } else {
    	c = t;
        d.open(), d.write('<!DOCTYPE html><html><head></head><body contenteditable="true"></body></html>'), d.close(), d.designMode = "On";
        ...
        try {
            ...
            // This works only for contextual Information...
            var contextInfo = document.getElementsByClassName("contextualInformationDescContainer")[0];
            var desc = contextInfo.getElementsByClassName("description")[0].innerHTML;
            d.body.innerHTML = desc;
